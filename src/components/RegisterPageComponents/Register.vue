<template>
    <v-app>
        <v-form v-model="valid" ref="form" @submit.prevent="submit">
            ...
            <v-text-field v-model="phone" :rules="[v => !!v || 'Phone Number is required']" :counter="11"
            ...
            <v-switch type="password" v-model="showPassword" hide-details true-value="hide" false-value="show"
                :label="`${showPassword}`" @click="switcVisibility"></v-switch>
